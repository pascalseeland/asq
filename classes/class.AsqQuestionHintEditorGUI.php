...
use srag\asq\UserInterface\Web\Component\Hint\Table\AsqHintsTableGUI;
use srag\asq\UserInterface\Web\Component\Hint\Table\HintTableFieldSelectHint;
...
class AsqQuestionHintEditorGUI
{
    ...
    public function showHintTable()
    {
        ...
        $table = new AsqHintsTableGUI($this, 'show', $this->question_dto);
    ...
    public function saveOrderNumbers()
    {
        ...
        $new_order_sugestions = AsqHintsTableGUI::getHintOrderSuggestionFromPost();
    ...
    public function showHintForm()
    {
        ...
        $hint_order_number = intval(filter_input(INPUT_GET, AsqHintsTableGUI::VAR_HINT_ORDER_NUMBER, FILTER_VALIDATE_INT));
    ...
    protected function confirmDeleteHints()
    {
        ...
        SWITCH ($_SERVER['REQUEST_METHOD']) {
            case "GET":
                $hint_order_numbers[] = intval(filter_input(INPUT_GET, AsqHintsTableGUI::VAR_HINT_ORDER_NUMBER, FILTER_VALIDATE_INT));
                break;
            case "POST":
                $hint_order_numbers = AsqHintsTableGUI::getSelectedHintOrderNumnbersFromPost();
                break;
        }
    ...
    protected function deleteHints()
    {
        ...
        SWITCH ($_SERVER['REQUEST_METHOD']) {
            case "GET":
                $hints_to_delete_order_numbers[] = intval(filter_input(INPUT_GET, AsqHintsTableGUI::VAR_HINT_ORDER_NUMBER, FILTER_VALIDATE_INT));
                break;
            case "POST":
