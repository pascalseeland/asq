...
class QuestionDto
{
     ...
     */
    public
    function getRevisionName() : string
    {
     ...
     */
    public
    function getIlComponentid() : string
    {
     ...
     */
    public
    function getLegacyData() : ?QuestionLegacyData
    {
     ...
     */
    public
    function getPlayConfiguration() : ?QuestionPlayConfiguration
    {
     ...
     */
    public
    function getAnswerOptions() : AnswerOptions
    {
     ...
     */
    public
    function getContentEditingMode() : ContentEditingMode
    {
     ...
     */
    public
    function getQuestionHints() : ?QuestionHints
    {
